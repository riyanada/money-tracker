                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="<?= base_url('records/search') ?>" method="POST">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">My Transactions
                                        ...
                                        <tbody>
                                            <?php foreach ($records as $record) { ?>
                                                <tr>
                                                    ...
                                                    <td><a href="<?php echo $record['attachment']; ?>">
                                                            <?php echo $record['attachment']; ?>
                                                        </a></td>
                                                    <td><a href="records/edit/<?php echo $record['id']; ?>"><i
                                                                class="fa fa-edit"></i></a></td>
                                                    <td><a href="records/delete/<?php echo $record['id']; ?>"><i
